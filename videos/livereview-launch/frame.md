...
colors:
  ...
  text-muted: "#1648cf"
  text-light: "#9A9A9A"
  accent-light: "rgba(29, 86, 240, 0.08)"
  accent-medium: "rgba(29, 86, 240, 0.15)"
  border: "rgba(29, 86, 240, 0.2)"
  card-bg: "rgba(29, 86, 240, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **Inter** (display) / **Lora** (body); ignore any preset font name lingering in prose.
